...
This section demonstrates all the Markdown syntax features supported by the theme, based on the [Markdown Cheat Sheet](https://www.markdownguide.org/cheat-sheet/):
...
![Alt text for image](/dark-matter/hero.webp)
...
|---------|-------------|--------|
| Blog Posts | Rich markdown support | ✅ Complete |
| Projects | GitHub integration | ✅ Complete |
| Notes | Quick documentation | ✅ Complete |
| CV | Professional resume | ✅ Complete |
